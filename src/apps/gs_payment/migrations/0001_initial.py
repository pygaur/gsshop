    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(blank=True, default=apps.gs_payment.models._make_uuid, max_length=100, unique=True, verbose_name='Reference')),
